...
<template>
    <Head title="Chat with Us">
        <meta name="description" content="Chat with Attenda support team. Get help with your HR management system, ask questions, or request assistance with your account." />
    </Head>
