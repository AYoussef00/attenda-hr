...
<template>
    <Head title="Attenda - Edit Asset | Update Asset Information">
        <meta name="description" content="تعديل معلومات الأصل في Attenda. تحديث تفاصيل الأصل، حالته، قيمته، ومعلومات الصيانة." />
    </Head>
