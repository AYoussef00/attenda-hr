                    ...
                    <div class="grid gap-4">
                        ...
                        <div class="grid gap-2">
                            ...
                            <select
                                ...
                                name="industry"
                                class="flex h-11 w-full rounded-xl border border-slate-200 !bg-white px-3 py-2 text-sm !text-gray-900 focus:border-slate-900 focus:outline-none focus:ring-1 focus:ring-slate-900 disabled:cursor-not-allowed disabled:opacity-50"
                            >
